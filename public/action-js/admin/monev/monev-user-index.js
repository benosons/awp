  ...
  $.ajax({
      ...
      if(code){
        for (let index = 0; index < data.length; index++) {
          ...
          $('#id_'+element['kode_aspek']+'_'+element['nomor']).html(element['id']);
          $('#nilai_'+element['kode_aspek']+'_'+element['nomor']).html(element['nilai']);
          $('#keterangan_'+element['kode_aspek']+'_'+element['nomor']).html(element['keterangan']);

          $('#sumber_'+element['kode_aspek']+'_'+element['nomor']).html(element['sumber']);
          $('#sumber_'+element['kode_aspek']+'_'+element['nomor']).attr('href', 'https://'+element['url']);
          $('#sumber_'+element['kode_aspek']+'_'+element['nomor']).attr('target','blank__');
          
          $('#tahun_'+element['kode_aspek']+'_'+element['nomor']).html(element['tahun']);
          $('#new_keterangan_'+element['kode_aspek']+'_'+element['nomor']).html(element['note']);
