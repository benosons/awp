...
class View extends \CodeIgniter\Controller
{
  ...
  function __construct(RequestInterface $request)
  {
	...
	public function summary()
	{
		...
		if($param == 1){
			$this->data['isOpen'] = 1;
			$this->data['script'] = $this->data['baseURL'].'/action-js/admin/summary/summary-index.js';
			return \Twig::instance()->display('admin/summary/summary-index.html', $this->data);
		}else if($param == 0){
			if($this->logged){
				$this->data['isOpen'] = 0;
				$this->data['script'] = $this->data['baseURL'].'/action-js/admin/summary/summary-index.js';
	...
	public function jadwal()
	{
		...
		if($param == 1){
			$this->data['isOpen'] = 1;
			$this->data['script'] = $this->data['baseURL'].'/action-js/admin/data/jadwal-index.js';
			return \Twig::instance()->display('admin/data/jadwal-index.html', $this->data);
		}else if($param == 0){
			if($this->logged){
				$this->data['isOpen'] = 0;
				$this->data['script'] = $this->data['baseURL'].'/action-js/admin/data/jadwal-index.js';
	...
	public function monev()
	{
		...
		if($param == 1){
			$this->data['isOpen'] = 1;
			$this->data['script'] = $this->data['baseURL'].'/action-js/admin/monev/monev-user-index.js';
			return \Twig::instance()->display('admin/monev/monev-user-index.html', $this->data);
		}else if($param == 0){
			if($this->logged){
				$this->data['isOpen'] = 0;
				$this->data['script'] = $this->data['baseURL'].'/action-js/admin/monev/monev-index.js';
				return \Twig::instance()->display('admin/monev/monev-index.html', $this->data);
			}else{
				return redirect('home');
			}
		}
	...
	public function monevcontrol()
	{
		...
		if($param == 1){
			...
			if($this->logged){
				$this->data['isOpen'] = 0;
				$this->data['script'] = $this->data['baseURL'].'/action-js/admin/monev/monev-control-index.js';
				return \Twig::instance()->display('admin/monev/monev-control-index.html', $this->data);
			}else{
				return redirect('home');
			}
		}
