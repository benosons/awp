...
$routes->add('pelaksana', 'View::pelaksana');
...
$routes->post('loaddata', 'Jsondata::loaddata');
...
$routes->post('loadlahan', 'Jsondata::loadlahan');
$routes->post('loadinformasi', 'Jsondata::loadinformasi');
